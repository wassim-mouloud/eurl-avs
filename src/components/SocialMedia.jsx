...
function SocialMedia() {
  return (
    <div className='flex flex-col items-center justify-center gap-2 py-4' >
        <h1 className='text-center lg:text-left font-bold text-[#009864] text-[30px] sm:text-[32px] md:text-[36px] lg:text-[40px] mb-10' >Rejoignez-nous sur les reseaux sociaux</h1>
